...
| #61 | `OpenClaw Global` context refresh pilot | Identity, writing style, boundaries, inheritance, and global context refresh without duplicating the `brand-context` contract. | #70, #71, #72 | `skills/brand-context/SKILL.md` |
| #62 | Ledger utility pilot | Category/channel ledger updates with `discord-approval-gate`; keep runtime notes separate from durable ledger entries. | #57, #70, #71, #72 | `skills/content-ledger/SKILL.md` |
| #63 | Category strategy pilot | Strategy planning using approved global/category context, not an isolated fixed-channel flow. | #70, #71, #72, #73 | `skills/strategy-planner/SKILL.md` |
